...
// 外码约束没生效
public class ManagementTable extends JTableDemo
{
    //
    ...
    public static void main(String[] args) {
        ...
        ManagementTable frame = new ManagementTable();
    ...
    public ManagementTable(){
        ...
        JLabel lbH2 = new JLabel("department_id： ");
        JLabel lbH3 = new JLabel("job： ");
        ...
        buttonModify.addMouseListener(new MouseAdapter() {
            public void mouseClicked (MouseEvent me) {
                ...
                String department_id = departmentText.getText();
                ...
                temp += " WHERE worker_id=\""+historyWorker_id+"\" AND department_id=\""+ historyDepartment_id+
                        "\" AND job=\""+historyJob+"\" AND salary=\""+historySalary+"\";";
                try {
        ...
        buttonCount.addMouseListener(new MouseAdapter() {
            public void mouseClicked (MouseEvent me) {
                ...
                String temp = "INSERT INTO "+dbName+" VALUE" +
                        "(\""+worker_id+"\", \""+department_id+"\", \""+job+"\", \""+salary+"\");";
                try {
                    System.out.println(temp);
                    insertInfo(temp);
                }
